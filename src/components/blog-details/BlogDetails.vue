            ...
            <div class="row">
                    ...
                    <div class="blog-details">
                        ...
                        <div class="article-content">
                            <div class="entry-meta">
                                <ul>
                                    <li><span>Posted On:</span>September 31, 2022</li>
                        ...
                        <div class="article-footer">
                            <div class="article-tags">
                                ...
                                <a href="/blog-1">Fashion</a>,
                                <a href="/blog-1">Games</a>,
                                <a href="/blog-1">Travel</a>
                            </div>
                                ...
                                <article class="comment-body">
                                    <footer class="comment-meta">
                                        <div class="comment-author vcard">
                                            <img src="../../assets/images/author1.jpg" class="avatar" alt="image">
                                ...
                                <ol class="children">
                                    <li class="comment">
                                        <article class="comment-body">
                                            <footer class="comment-meta">
                                                <div class="comment-author vcard">
                                                    <img src="../../assets/images/author2.jpg" class="avatar" alt="image">
                                    ...
                                    <ol class="children">
                                        <li class="comment">
                                            <article class="comment-body">
                                                <footer class="comment-meta">
                                                    <div class="comment-author vcard">
                                                        <img src="../../assets/images/author3.jpg" class="avatar" alt="image">
                                ...
                                <ol class="children">
                                    <li class="comment">
                                        <article class="comment-body">
                                            <footer class="comment-meta">
                                                <div class="comment-author vcard">
                                                    <img src="../../assets/images/author4.jpg" class="avatar" alt="image">
                                                    <b class="fn">James Anderson</b>
                                                    <span class="says">says:</span>
                                                </div>
                ...
                <div class="col-lg-4 col-md-12">
                    <aside class="widget-area" id="secondary">
                        ...
                        <div class="widget widget_vibion_posts_thumb">
